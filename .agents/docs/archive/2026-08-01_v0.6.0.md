...
**STATUS: WORKFLOW COMPLETE** (shipped as v0.6.0, released 2026-08-01)
**Author:** Architect persona (Trinity Stack Protocol)
**Date:** 2026-07-30
**Branch:** `feat/0.6.0` → merged to `main` (fast-forward, 2026-08-03) after the user's manual test.
Followed by the post-0.6.0 readability pass and two new editor features (tables + strikethrough),
released together as **v0.7.0** (2026-08-03).
