...
class TaskDetailDialog(QDialog):
    ...
    def init_ui(self):
        ...
        # ========== TARJETA DE METADATOS (4 FILAS) ==========
        meta = QFrame()
        meta.setObjectName("TaskMetaCard")
        meta.setAttribute(Qt.WA_StyledBackground, True)
        meta.setStyleSheet(
            f"#TaskMetaCard {{ background-color: {styles.COLORS['bg_card']}; border: 1px solid {styles.COLORS['border']}; border-radius: 12px; }}"
        )
        ...
        row_1 = QHBoxLayout()
        row_1.setSpacing(10)
        row_1.addWidget(QLabel(t("task_detail.timer_label")))
        ...
        row_1.addWidget(self.timer_toggle_btn)
        ...
        row_1.addWidget(self.timer_clear_btn)
        self.timer_elapsed_label = QLabel("")
        self.timer_elapsed_label.setStyleSheet(f"color: {styles.COLORS['text_muted']}; font-size: 11px;")
        row_1.addWidget(self.timer_elapsed_label)
        row_1.addStretch()
        meta_l.addLayout(row_1)

        # Fila 2: vencimiento + selector de repetición (segunda fila)
        row_2 = QHBoxLayout()
        row_2.setSpacing(8)
        row_2.addWidget(QLabel(t("task_detail.due_label")))
        ...
        row_2.addWidget(self.due_enable_chk)
        self.due_date_edit = QDateEdit()
        self.due_date_edit.setCalendarPopup(True)
        self.due_date_edit.setDate(QDate.currentDate())
        self.due_date_edit.setDisplayFormat("yyyy-MM-dd")
        self.due_date_edit.setEnabled(False)
        row_2.addWidget(self.due_date_edit)
        ...
        row_2.addWidget(self.due_time_chk)
        ...
        row_2.addWidget(self.recurrence_combo)
        row_2.addStretch()
        meta_l.addLayout(row_2)

        # Fila 3: etiquetas
        row_3 = QHBoxLayout()
        row_3.setSpacing(10)
        row_3.addWidget(QLabel(t("task_detail.tags_label")))
        ...
        row_3.addWidget(self.tags_container_widget)
        ...
        row_3.addWidget(self.add_tag_btn)
        ...
        # Fila 4: prioridad + tablero vinculado
        row_4 = QHBoxLayout()
        row_4.setSpacing(10)
        row_4.addWidget(QLabel(t("task_detail.priority_label")))
        ...
        row_4.addWidget(self.linked_board_combo)
        row_4.addStretch()
        meta_l.addLayout(row_4)

        # ========== CUERPO: (METADATA + NOTES) | JOURNAL ==========
        body = QWidget()
        body_l = QHBoxLayout(body)
        body_l.setContentsMargins(30, 10, 30, 0)
        body_l.setSpacing(18)

        # --- Panel izquierdo: Metadata + Notes ---
        left_panel = QWidget()
