...
STRINGS_EN = {
    ...
    'main.tray.due_soon_title': 'Ekin — {count} task(s) due soon',
    ...
    'board_view.column_edit.wip_label': '<b>WIP limit</b> (0 = no limit):',
    'board_view.column_edit.wip_none': 'No limit',
    ...
    'widgets.column.wip_tooltip': 'Work in progress: {count} of {limit}',
    ...
    'sidebar.mywork_tooltip': 'My Work — everything due across boards (Ctrl+0)',
    'palette.window_title': 'Command palette',
    'palette.placeholder': 'Type a command or search tasks…  (start with + to create a task)',
    'palette.section_commands': 'COMMANDS',
    'palette.section_tasks': 'TASKS',
    'palette.quick_capture': 'Create task: “{title}”',
    'palette.no_results': 'No matching commands or tasks.',
    'palette.cmd_new_task': 'New task',
    'palette.cmd_new_column': 'New column',
    'palette.cmd_new_board': 'New board',
    'palette.cmd_my_work': 'Open My Work',
    'palette.cmd_calendar': 'Open Calendar',
    'palette.cmd_search': 'Open Search',
    'palette.cmd_settings': 'Open Settings',
    'palette.cmd_shortcuts': 'Show keyboard shortcuts',
    'palette.cmd_toggle_theme': 'Toggle light / dark theme',
    'palette.cmd_dashboard': 'Open Analytics',
    'palette.cmd_open_logs': 'Open logs folder',
    'dashboard.title': 'Analytics',
    'dashboard.close_btn': 'Close',
    'dashboard.export_btn': 'Export PDF',
    'dashboard.export_title': 'Export analytics PDF',
    'dashboard.export_done': 'Report saved to {path}',
    'dashboard.empty': 'No data yet — create a board and some tasks.',
    'dashboard.tile_boards': 'Boards',
    'dashboard.tile_tasks': 'Tasks',
    'dashboard.tile_overdue': 'Overdue',
    'dashboard.tile_due_week': 'Due this week',
    'dashboard.tile_timers': 'Running timers',
    'dashboard.chart_per_board': 'Tasks per board',
    'dashboard.chart_due_status': 'Due status',
    'dashboard.status_overdue': 'Overdue',
    'dashboard.status_this_week': 'This week',
    'dashboard.status_later': 'Later',
    'dashboard.status_no_due': 'No due date',
    'mywork.title': 'My Work',
    'mywork.close_btn': 'Close',
    'mywork.group_in_progress': 'IN PROGRESS',
    'mywork.group_overdue': 'OVERDUE',
    'mywork.group_today': 'TODAY',
    'mywork.group_tomorrow': 'TOMORROW',
    'mywork.group_upcoming': 'LATER THIS WEEK',
    'mywork.empty': 'Nothing due and no timers running. Enjoy the clear runway. ✨',
    ...
    'settings.reminder_lead_label': 'Reminder lead time',
    'settings.reminder_lead_desc': 'Also notify about tasks due within this many days (0 = day-of only).',
    'settings.weekly_digest_label': 'Weekly review',
    'settings.weekly_digest_desc': 'Once a week, show a summary of overdue and due-this-week tasks.',
    'digest.window_title': 'Weekly review',
    'digest.header': 'Here is your week',
    'digest.summary': '{overdue} overdue · {week} due this week',
    'digest.group_overdue': 'OVERDUE',
    'digest.group_this_week': 'DUE THIS WEEK',
    'digest.open_my_work_btn': 'Open My Work',
    'digest.close_btn': 'Close',
    ...
    'shortcuts.item_my_work': 'Ctrl+0 — Open "My Work" (everything due across boards)',
    'shortcuts.item_command_palette': 'Ctrl+K — Command palette (search tasks + run actions)',
    'shortcuts.item_dashboard': 'Ctrl+D — Open the Analytics dashboard',
    ...
    'task_detail.breakdown_btn': 'Break down',
    'task_detail.summarize_btn': 'Summarize',
    'ai.breakdown.title': 'Break down into tasks',
    'ai.breakdown.hint': 'One task per line. Edit freely, then create them in this card’s column.',
    'ai.breakdown.confirm_btn': 'Create tasks',
    'ai.breakdown.created': 'Created {count} task(s) in this column.',
    'ai.breakdown.default_title': 'Task',
    'ai.breakdown.phase_plan': 'Plan: {title}',
    'ai.breakdown.phase_implement': 'Implement: {title}',
    'ai.breakdown.phase_verify': 'Verify: {title}',
    'ai.summary.title': 'Summarize journal',
    'ai.summary.hint': 'A quick recap of this card’s journal. Edit, then post it as a new entry.',
    'ai.summary.confirm_btn': 'Post to journal',
    'ai.summary.empty': 'No journal entries yet to summarize.',
    'ai.summary.what_happened': 'What happened',
    'ai.summary.next_step': 'Next step',
    'ai.enhance_btn': '✨ Enhance with local AI',
    'ai.enhance_generating': 'Generating…',
    ...
    'sync.summary_up_to_date': 'Already up to date.',
    'sync.summary_exported': 'Synced — local changes uploaded.',
    'sync.summary_synced': 'Synced',
    'sync.summary_updated': '{count} task(s) updated',
...
STRINGS_ES = {
    ...
    'main.tray.due_soon_title': 'Ekin — {count} tarea(s) vencen pronto',
    ...
    'board_view.column_edit.wip_label': '<b>Límite WIP</b> (0 = sin límite):',
    'board_view.column_edit.wip_none': 'Sin límite',
    ...
    'widgets.column.wip_tooltip': 'Trabajo en curso: {count} de {limit}',
    ...
    'sidebar.mywork_tooltip': 'Mi trabajo — todo lo que vence en tus tableros (Ctrl+0)',
    'palette.window_title': 'Paleta de comandos',
    'palette.placeholder': 'Escribe un comando o busca tareas…  (empieza con + para crear una tarea)',
    'palette.section_commands': 'COMANDOS',
    'palette.section_tasks': 'TAREAS',
    'palette.quick_capture': 'Crear tarea: «{title}»',
    'palette.no_results': 'No hay comandos ni tareas que coincidan.',
    'palette.cmd_new_task': 'Nueva tarea',
    'palette.cmd_new_column': 'Nueva columna',
    'palette.cmd_new_board': 'Nuevo tablero',
    'palette.cmd_my_work': 'Abrir Mi trabajo',
    'palette.cmd_calendar': 'Abrir Calendario',
    'palette.cmd_search': 'Abrir Búsqueda',
    'palette.cmd_settings': 'Abrir Ajustes',
    'palette.cmd_shortcuts': 'Ver atajos de teclado',
    'palette.cmd_toggle_theme': 'Cambiar tema claro / oscuro',
    'palette.cmd_dashboard': 'Abrir Analíticas',
    'palette.cmd_open_logs': 'Abrir carpeta de logs',
    'dashboard.title': 'Analíticas',
    'dashboard.close_btn': 'Cerrar',
    'dashboard.export_btn': 'Exportar PDF',
    'dashboard.export_title': 'Exportar PDF de analíticas',
    'dashboard.export_done': 'Informe guardado en {path}',
    'dashboard.empty': 'Aún no hay datos — crea un tablero y algunas tareas.',
    'dashboard.tile_boards': 'Tableros',
    'dashboard.tile_tasks': 'Tareas',
    'dashboard.tile_overdue': 'Atrasadas',
    'dashboard.tile_due_week': 'Vencen esta semana',
    'dashboard.tile_timers': 'Temporizadores activos',
    'dashboard.chart_per_board': 'Tareas por tablero',
    'dashboard.chart_due_status': 'Estado de vencimiento',
    'dashboard.status_overdue': 'Atrasadas',
    'dashboard.status_this_week': 'Esta semana',
    'dashboard.status_later': 'Más adelante',
    'dashboard.status_no_due': 'Sin fecha',
    'mywork.title': 'Mi trabajo',
    'mywork.close_btn': 'Cerrar',
    'mywork.group_in_progress': 'EN CURSO',
    'mywork.group_overdue': 'ATRASADAS',
    'mywork.group_today': 'HOY',
    'mywork.group_tomorrow': 'MAÑANA',
    'mywork.group_upcoming': 'ESTA SEMANA',
    'mywork.empty': 'Nada vence y ningún temporizador en marcha. Disfruta del respiro. ✨',
    ...
    'settings.reminder_lead_label': 'Aviso por anticipación',
    'settings.reminder_lead_desc': 'Avisa también de tareas que vencen dentro de estos días (0 = solo el día).',
    'settings.weekly_digest_label': 'Resumen semanal',
    'settings.weekly_digest_desc': 'Una vez por semana, muestra un resumen de atrasadas y de esta semana.',
    'digest.window_title': 'Resumen semanal',
    'digest.header': 'Así va tu semana',
    'digest.summary': '{overdue} atrasadas · {week} esta semana',
    'digest.group_overdue': 'ATRASADAS',
    'digest.group_this_week': 'VENCEN ESTA SEMANA',
    'digest.open_my_work_btn': 'Abrir Mi trabajo',
    'digest.close_btn': 'Cerrar',
    ...
    'shortcuts.item_my_work': 'Ctrl+0 — Abrir "Mi trabajo" (todo lo que vence en tus tableros)',
    'shortcuts.item_command_palette': 'Ctrl+K — Paleta de comandos (buscar tareas + ejecutar acciones)',
    'shortcuts.item_dashboard': 'Ctrl+D — Abrir el panel de Analíticas',
    ...
    'task_detail.breakdown_btn': 'Desglosar',
    'task_detail.summarize_btn': 'Resumir',
    'ai.breakdown.title': 'Desglosar en tareas',
    'ai.breakdown.hint': 'Una tarea por línea. Edita libremente y créalas en la columna de esta tarjeta.',
    'ai.breakdown.confirm_btn': 'Crear tareas',
    'ai.breakdown.created': 'Se han creado {count} tarea(s) en esta columna.',
    'ai.breakdown.default_title': 'Tarea',
    'ai.breakdown.phase_plan': 'Planificar: {title}',
    'ai.breakdown.phase_implement': 'Implementar: {title}',
    'ai.breakdown.phase_verify': 'Verificar: {title}',
    'ai.summary.title': 'Resumir diario',
    'ai.summary.hint': 'Un resumen del diario de esta tarjeta. Edítalo y publícalo como nueva entrada.',
    'ai.summary.confirm_btn': 'Publicar en el diario',
    'ai.summary.empty': 'Aún no hay entradas de diario que resumir.',
    'ai.summary.what_happened': 'Qué se hizo',
    'ai.summary.next_step': 'Siguiente paso',
    'ai.enhance_btn': '✨ Mejorar con IA local',
    'ai.enhance_generating': 'Generando…',
    'task_detail.load_error_title': 'Error',
    ...
    'sync.summary_up_to_date': 'Ya está al día.',
    'sync.summary_exported': 'Sincronizado — cambios locales subidos.',
    'sync.summary_synced': 'Sincronizado',
    'sync.summary_updated': '{count} tarea(s) actualizada(s)',
