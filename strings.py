...
STRINGS_EN = {
    ...
    'markdown_edit.table_menu': 'Table',
    'markdown_edit.table_insert_row_above': 'Insert row above',
    'markdown_edit.table_insert_row_below': 'Insert row below',
    'markdown_edit.table_insert_col_left': 'Insert column to left',
    'markdown_edit.table_insert_col_right': 'Insert column to right',
    'markdown_edit.table_delete_row': 'Delete row',
    'markdown_edit.table_delete_col': 'Delete column',
    'markdown_edit.table_delete_table': 'Delete entire table',
    ...
    'ai_spec.mode_sw_feature_plan': 'Feature Plan for SW Dev (Antigravity / Claude Code / Cursor)',
    'ai_spec.mode_study_socratic': 'Study & Socratic Plan (Students / Exam Prep)',
    'ai_spec.mode_analyst_business': 'Analyst & Business Plan (Viability / Projects / Ideas)',
    'ai_spec.mode_action_breakdown': 'Action Plan (Task Breakdown & Execution)',
    'ai_spec.generate_btn': 'Generate with Local AI',
    'ai_spec.copy_prompt_btn': 'Copy Master Prompt',
    'ai_spec.view_prompt_btn': 'View Master Prompt',
    'ai_spec.view_spec_btn': 'View Generated SPEC',
    'ai_spec.prompt_copied_toast': 'Master prompt copied to clipboard! Ready to paste into Claude, ChatGPT, Cursor, etc.',
...
STRINGS_ES = {
    ...
    'markdown_edit.table_menu': 'Tabla',
    'markdown_edit.table_insert_row_above': 'Insertar fila arriba',
    'markdown_edit.table_insert_row_below': 'Insertar fila abajo',
    'markdown_edit.table_insert_col_left': 'Insertar columna a la izquierda',
    'markdown_edit.table_insert_col_right': 'Insertar columna a la derecha',
    'markdown_edit.table_delete_row': 'Eliminar fila',
    'markdown_edit.table_delete_col': 'Eliminar columna',
    'markdown_edit.table_delete_table': 'Eliminar tabla completa',
    ...
    'ai_spec.mode_sw_feature_plan': 'Feature Plan para SW Dev (Antigravity / Claude Code / Cursor)',
    'ai_spec.mode_study_socratic': 'Plan de Estudio & Socrático (Estudiantes / Opositores)',
    'ai_spec.mode_analyst_business': 'Plan de Negocio & Analista (Viabilidad / Proyectos / Ideas)',
    'ai_spec.mode_action_breakdown': 'Plan de Acción (Desglose de Tareas & Ejecución)',
    'ai_spec.generate_btn': 'Generar con IA Local',
    'ai_spec.copy_prompt_btn': 'Copiar Prompt Maestro',
    'ai_spec.view_prompt_btn': 'Ver Prompt Maestro',
    'ai_spec.view_spec_btn': 'Ver SPEC Generada',
    'ai_spec.prompt_copied_toast': '¡Prompt maestro copiado al portapapeles! Listo para pegar en Claude, ChatGPT, Cursor, etc.',
