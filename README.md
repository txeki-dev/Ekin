...
- **Themes & Settings**: A settings screen with a **Light / Dark theme** toggle (light "Warm Shell" is the default), notification prefs, a configurable task-timer alert threshold, and a remembered window size.
